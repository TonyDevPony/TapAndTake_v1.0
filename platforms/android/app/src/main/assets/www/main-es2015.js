...
const routes = [
    ...
    {
        path: 'qr',
        loadChildren: () => __webpack_require__.e(/*! import() | main-pages-user-qr-page-qr-module */ "main-pages-user-qr-page-qr-module").then(__webpack_require__.bind(null, /*! ./main.pages/user/qr.page/qr.module */ "./src/app/main.pages/user/qr.page/qr.module.ts")).then(m => m.QRPageModule)
    },
    {
        path: 'forgot-password',
        loadChildren: () => __webpack_require__.e(/*! import() | auth-pages-forgot-password-page-forgot-password-module */ "auth-pages-forgot-password-page-forgot-password-module").then(__webpack_require__.bind(null, /*! ./auth.pages/forgot-password.page/forgot-password.module */ "./src/app/auth.pages/forgot-password.page/forgot-password.module.ts")).then(m => m.ForgotPasswordPageModule)
    },
    {
        path: 'password-reset',
        loadChildren: () => __webpack_require__.e(/*! import() | auth-pages-password-reset-password-reset-module */ "auth-pages-password-reset-password-reset-module").then(__webpack_require__.bind(null, /*! ./auth.pages/password-reset/password-reset.module */ "./src/app/auth.pages/password-reset/password-reset.module.ts")).then(m => m.PasswordResetPageModule)
    },
    {
        path: 'user-settings',
        loadChildren: () => Promise.all(/*! import() | main-pages-user-user-settings-user-settings-module */[__webpack_require__.e("default~auth-pages-login-page-login-module~auth-pages-register-page-register-module~main-pages-user-~e0eb3dc2"), __webpack_require__.e("main-pages-user-user-settings-user-settings-module")]).then(__webpack_require__.bind(null, /*! ./main.pages/user/user-settings/user-settings.module */ "./src/app/main.pages/user/user-settings/user-settings.module.ts")).then(m => m.UserSettingsPageModule)
    },
    {
        path: 'admin-coffee-houses',
        loadChildren: () => __webpack_require__.e(/*! import() | main-pages-admin-admin-coffee-houses-admin-coffee-houses-module */ "main-pages-admin-admin-coffee-houses-admin-coffee-houses-module").then(__webpack_require__.bind(null, /*! ./main.pages/admin/admin-coffee-houses/admin-coffee-houses.module */ "./src/app/main.pages/admin/admin-coffee-houses/admin-coffee-houses.module.ts")).then(m => m.AdminCoffeeHousesPageModule)
    },
    {
        path: 'admin-settings',
...
/* harmony import */ var _services_fileStorageForUser_service_file_storage_for_user_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/fileStorageForUser.service/file-storage-for-user.service */ "./src/app/services/fileStorageForUser.service/file-storage-for-user.service.ts");
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, keyboard, authService, FileStorageUser, network) {
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
        ...
        _services_fileStorageForUser_service_file_storage_for_user_service__WEBPACK_IMPORTED_MODULE_8__["FileStorageForUserService"],
...
module.exports = __webpack_require__(/*! /home/tony/TapAndTake_v1.0/src/main.ts */"./src/main.ts");
